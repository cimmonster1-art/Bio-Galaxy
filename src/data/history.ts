...
export const HISTORY_CHAPTERS: HistoryChapter[] = [
  ...
  { id: 'cambrian', label: 'Cambrian diversification', ageGya: 0.539, time: '539 million years ago', scale: Scale.Class, detail: 'Over a few tens of millions of years, most major animal body plans appear in the fossil record, from arthropods to the first chordates.', color: '#d5d95b' },
  { id: 'land', label: 'Life on land', ageGya: 0.47, time: 'about 470 million years ago', scale: Scale.Order, detail: 'Plants, fungi, and arthropods colonize the continents, and forests and soils begin to reshape the atmosphere and the carbon cycle.', color: '#e2af55' },
  { id: 'dinosaurs', label: 'Age of dinosaurs', ageGya: 0.23, time: 'about 230 million years ago', scale: Scale.Order, detail: 'Dinosaurs rise to dominate terrestrial ecosystems through the Mesozoic, alongside the first mammals and flowering plants.', color: '#bcae5a' },
  { id: 'mammals', label: 'Mammal radiation', ageGya: 0.066, time: '66 million years ago', scale: Scale.Family, detail: 'After an asteroid impact ends the non-avian dinosaurs, surviving mammal lineages rapidly diversify into the niches left open.', color: '#ec845c' },
