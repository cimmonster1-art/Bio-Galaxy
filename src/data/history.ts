...
export const HISTORY_CHAPTERS: HistoryChapter[] = [
  ...
  { id: 'cambrian', label: 'Cambrian diversification', ageGya: 0.539, time: '539 million years ago', scale: Scale.Biome, detail: 'Over a few tens of millions of years, most major animal body plans appear in the fossil record, from arthropods to the first chordates.', color: '#d5d95b' },
