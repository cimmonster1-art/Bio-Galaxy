...
>>>>>>> origin/main
    ...
    format: 'glb',
    url: '/models/anatomy-body.glb',
    repo: 'LluisV/Z-Anatomy-Sample',
    repoUrl: 'https://github.com/LluisV/Z-Anatomy-Sample',
    license: 'CC-BY-SA 4.0',
    attribution: 'Z-Anatomy (BodyParts3D / DBCLS)',
    animated: false,
  },
  {
    id: 'skeleton',
    label: 'Human skeleton (Z-Anatomy)',
    organism: 'Homo sapiens',
    taxonHint: 'homo_sapiens',
    scale: Scale.Organism,
    format: 'glb',
    url: '/models/anatomy-skeleton.glb',
    repo: 'LluisV/Z-Anatomy-Sample',
    repoUrl: 'https://github.com/LluisV/Z-Anatomy-Sample',
    license: 'CC-BY-SA 4.0',
    attribution: 'Z-Anatomy (BodyParts3D / DBCLS)',
